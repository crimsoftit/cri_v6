              ...
              body: NestedScrollView(
                ...
                body: const TabBarView(
                  ...
                  children: [
                    ...
                    CContactItem(space: 'friends'),
                    CContactItem(space: 'trashed'),
                ...
                children: [
                  FlutterFloaty(
                    backgroundColor:
                        ...
                        : CColors.black,
                    borderRadius: 15.0,
                    builder: (context) => Icon(Icons.add, color: Colors.white),
                    growingFactor: 1.1,
                    height: 60,
                    ...
                    // Circular shape
                    onTap: () async {
                      await contactsController.addContactActionModal(context);
                    },
